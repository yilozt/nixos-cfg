...
in
{
  ...
  users.extraUsers.luo.extraGroups =
    [ "kvm" "libvirtd" "qemu-libvirtd" "disk" "video" ];
  ...
  systemd.services.vm-disks-loop-devices =
    let
      WIN = "/dev/disk/by-partuuid/e431754b-74fc-4e8b-ac92-2f6677141345"; # C:\
      DATA = "/dev/disk/by-partuuid/a145724d-6e97-4dfd-9178-76c9ce0d8a51"; # D:\
    in
    {
  ...
  environment.systemPackages =
    let
      ...
      '';
    in
    [ create-vm start-vm pkgs.virt-manager pkgs.dnsmasq pkgs.iptables ];
}
